...
\subsubsection{Outline of the research program}
...
\subsubsection{Defining stripes in CTL}
...
\end{equation}
??? Reicht das, oder muss zusätzlich initial condition gefordert werden???
Testen im Programm mit einfacher Parametermenge ob nur die mit initial
condition übrigbleiben!!!
