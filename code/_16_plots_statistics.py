...
combined_results_shelvenames = ["combined_results_AL_from_unconstrained_without_overregulated.db", "combined_results_from_unconstrained_without_overregulated.db"]
